package xst.app.com.myutils.views;
...
public class ProgressView extends View {
    ...
    private void init() {
        ...
        mForPain.setStrokeCap(Paint.Cap.SQUARE);
        ...
        mBacPain.setStrokeCap(Paint.Cap.SQUARE);
//        mBacPain.setStrokeCap(Paint.Cap.ROUND);
        ...
        mTextPain.setStrokeCap(Paint.Cap.SQUARE);
    ...
    public void setProgresss(float mProgress) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawArc(oval, mStartAngle, 360, false, mBacPain);
        //canvas.drawArc(oval, mStartAngle, mSweepAngle * mProgress / 100, false, mForPain);
        canvas.drawArc(oval, mStartAngle, 360* mProgress / 100, false, mForPain);
        if(withText)
