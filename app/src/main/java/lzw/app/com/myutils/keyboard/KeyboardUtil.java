package lzw.app.com.myutils.keyboard;
...
public class KeyboardUtil {
    ...
    private TextView mSafeView;//安全输入提示
    ...
    public KeyboardUtil(Activity activity, boolean ifRandom) {
        ...
        mSafeView = (TextView) mActivity.findViewById(R.id.safe_view);
    }
    ...
    public void attachTo(EditText editText) {
        if(editText == null) {
            editText.setText("editText is null");
        }else{
    ...
    private KeyboardView.OnKeyboardActionListener mOnKeyboardActionListener = new KeyboardView.OnKeyboardActionListener() {
        ...
        public void onKey(int primaryCode, int[] keyCodes) {
            ...
            if (primaryCode == Keyboard.KEYCODE_DELETE) {// 回退
                ...
                if(primaryCode == 46 && str.contains(".")){
                   return;
                }
    ...
    public void hideKeyboard() {
        ...
        if (visibility == View.VISIBLE) {
            ...
            mSafeView.setVisibility(View.GONE);
        }
    }
}